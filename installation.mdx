...
description: "Full installation guide for Corpen: system requirements, dependency setup, database migration, and first-run configuration for production and local environments."
---
