---
title: "Get Started with Corpen in Under 10 Minutes"
...
The `Dockerfile` already runs all four of these steps during its build stage, so containerized deployments receive an optimized build automatically.
