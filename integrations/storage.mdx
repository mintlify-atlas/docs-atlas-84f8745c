...
description: "Configure Corpen's file storage — AWS S3, Google Cloud Storage, SFTP, or local disk — for employee photos, correspondence signatures, and PDF archives."
---
