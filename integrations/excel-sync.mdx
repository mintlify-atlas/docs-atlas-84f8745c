---
title: "Excel Sync: Bulk Data Import and Export in Corpen"
sidebarTitle: "Excel Sync"
description: "Use Corpen's Excel synchronization tools to bulk-import and export associates, demographics, accounting data, and more using Maatwebsite Excel and PhpSpreadsheet."
---
...
- `app/Exports/Asociado/CiudadExport.php`, `DireccionExport.php`, `PaisExport.php`, `RegionExport.php`, `SubregionExport.php` — demographic reference tables
...
- `app/Imports/Asociado/TransaccionesImport.php` — associate transaction import
- `app/Imports/Cartera/ExcelMorososImport.php` — portfolio delinquent-account import
- `app/Imports/Contabilidad/` — accounting-specific import classes
...
- `app/Imports/PolizasImport.php` — bulk insurance policy sync
