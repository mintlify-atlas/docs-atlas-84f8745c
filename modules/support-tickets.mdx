...
| `GET /soportes/mis-soportes` | `ScpSoporteController@misSoportes` | Tickets assigned to the authenticated user |
...
| `POST /soportes/{scpSoporte}/asignar` | `ScpSoporteController@asignarAgente` | Assign an agent to a ticket |
| `POST /soportes/{scpSoporte}/cambiar-estado` | `ScpSoporteController@cambiarEstado` | Direct state change |
| `GET /soportes/buscar-rapido` | `ScpSoporteController@quickSearch` | JS autocomplete search |
